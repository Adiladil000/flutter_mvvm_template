...
class HeaderButton extends StatelessWidget {
  ...
  const HeaderButton({Key? key, required this.titleText, this.onPressed}) : super(key: key);
        ...
        child: Wrap(
          ...
          children: [
            Text(
              ...
              style: context.textTheme.headline2!.copyWith(color: context.colorScheme.onError),
            ),
            Icon(
              Icons.arrow_right,
