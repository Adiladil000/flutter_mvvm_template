...
main() {
  ...
  test('CoreDio List', () async {
    final data =
        await service!.fetch<List<PostModel>, PostModel>('/posts', type: HttpType.GET, parseModel: PostModel());
  ...
  test('CoreDio List No Network', () async {
    final data = await service!
        .fetchNoNetwork<List<PostModel>, PostModel>('/posts', type: HttpType.GET, parseModel: PostModel());
